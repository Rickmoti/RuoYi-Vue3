  ...
  <div id="tags-view-container" class="tags-view-container">
    ...
    <ul v-show="visible" :style="{ left: left + 'px', top: top + 'px' }" class="contextmenu">
      ...
      <li v-if="!isAffix(selectedTag)" @click="closeSelectedTag(selectedTag)">
        <close style="width: 1em; height: 1em;" /> {{$t('tagsView.closeSelectedTag')}}
      </li>
      <li @click="closeOthersTags">
        <circle-close style="width: 1em; height: 1em;" />{{$t('tagsView.closeOthers')}}
      </li>
      <li v-if="!isFirstView()" @click="closeLeftTags">
        <back style="width: 1em; height: 1em;" /> {{$t('tagsView.closeLeftTags')}}
      </li>
      <li v-if="!isLastView()" @click="closeRightTags">
        <right style="width: 1em; height: 1em;" /> {{$t('tagsView.closeRightTags')}}
      </li>
