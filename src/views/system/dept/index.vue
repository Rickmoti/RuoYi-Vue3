   ...
   <div class="app-container">
      ...
      <el-row :gutter="10" class="mb8">
         ...
         <el-col :span="1.5">
            ...
            >{{$t('button.expandCollapse')}}</el-button>
         </el-col>
      ...
      >
         ...
         <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
               ...
               <el-button v-if="scope.row.parentId != 0" link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:dept:remove']">{{$t('button.del')}}</el-button>
            </template>
         </el-table-column>
      </el-table>
